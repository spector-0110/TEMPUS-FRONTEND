    ...
    <div className="w-full max-w-4xl mx-auto px-1 sm:px-4 md:px-6">
      <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-blue-50/30">
        ...
        <CardContent className="px-2 sm:px-6 md:px-8 max-h-[70vh] overflow-y-auto">          {/* Doctors Grid - Highly Responsive */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-2 sm:gap-4 lg:gap-6 pr-1 sm:pr-2 scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-gray-100">
